...
window.addEventListener('DOMContentLoaded', () => {
    let path = '';
    let disabled = true;
    let settings = kafka_service_1.KafkaSettings.createProdSettings();
    ...
    settingsSelect.addEventListener('change', (e) => {
        ...
        switch (value) {
            case kafka_service_1.KafkaSettingsEnum.PROD:
                settings = kafka_service_1.KafkaSettings.createProdSettings();
                break;
            case kafka_service_1.KafkaSettingsEnum.PREPROD:
                settings = kafka_service_1.KafkaSettings.createPreProdSettings();
                break;
            default:
                break;
        }
